...
_ORIGINAL_MODULE = 'cutagent_cli.core.render_engine'
_ORIGINAL_PACKAGE = 'cutagent_cli.core'
_ORIGINAL_BASENAME = 'render_engine.py'
_PARTS = (
    'part_001.py',
    'part_002.py',
    'part_003.py',
...
setattr(_facade_sys.modules[_ORIGINAL_PACKAGE], 'render_engine', _facade_module)
