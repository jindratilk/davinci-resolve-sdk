...
_ORIGINAL_MODULE = 'cutagent_cli.core.timeline_ops'
_ORIGINAL_PACKAGE = 'cutagent_cli.core'
_ORIGINAL_BASENAME = 'timeline_ops.py'
_PARTS = (
    'part_001.py',
    'part_002.py',
    'part_003.py',
...
setattr(_facade_sys.modules[_ORIGINAL_PACKAGE], 'timeline_ops', _facade_module)
