...
def build_multicam_support_matrix() -> dict[str, Any]:
    return {
        ...
        "persistent_gui_operation_support": {
            ...
            "per_angle_grading_and_braw_raw_workflow": "partial",
            "per_angle_braw_raw_workflow": "supported",
            "per_angle_source_grade_cdl": "unsupported",
        },
        "persistent_gui_operation_notes": {
            ...
            "source_grade_cdl": "unsupported_until_the_exact_nested_multicam_timeline_item_is_addressable_and_render_verified",
        },
        "latest_live_verification": dict(LATEST_LIVE_VERIFICATION),
        "tiers": {
