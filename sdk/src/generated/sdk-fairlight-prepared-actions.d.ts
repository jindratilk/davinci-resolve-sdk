...
export declare const CUTAGENT_SDK_FAIRLIGHT_RAW_AUDIO_CLIP_ACTION_IDS: readonly ("cutagent.action.fairlight.ai.voice_isolation" | "cutagent.action.fairlight.eq.set" | "cutagent.action.fairlight.item_source.patch")[];
