import { z } from "zod";
export declare const CUTAGENT_PREPARED_ACTION_PROTOCOL_VERSION: 1;
export declare const CUTAGENT_PREPARED_ACTION_KERNEL_DIGEST: "sha256:f3b206e529ef03f1e5ca76713e607782a8d7159ef9b6b33345f381ba426857c4";
export declare const CUTAGENT_PREPARED_ACTION_CONTRACT_DIGEST: "sha256:65f9c16dfdff6f89f8b1acbd0a0013fc0b4366537180fc39ee81853954f61f94";
export declare const CUTAGENT_PREPARED_ACTION_CAPABILITY_DIGEST: "sha256:b114bf76ee3c1670fd2d8e427d76d3c91a2b32564419c3a033328b62c9c86579";
...
export declare const sdkAdmitPreparedActionRequestSchema: z.ZodObject<{
    ...
    policyDecisionDigest: z.ZodOptional<z.ZodString>;
}, z.core.$strict>;
export declare const sdkAcceptPreparedActionPolicyRequestSchema: z.ZodObject<{
    receipt: z.ZodString;
    policyAttestation: z.ZodString;
    policyDecisionDigest: z.ZodString;
}, z.core.$strict>;
...
export type SdkAcceptPreparedActionPolicyRequest = z.infer<typeof sdkAcceptPreparedActionPolicyRequestSchema>;
